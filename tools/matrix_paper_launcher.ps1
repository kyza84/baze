...
$variants = @(
  ...
  @{ name='mx30_guarded_balanced'; base='mx28_pool_rework_balanced'; overrides=@{
      # Profit-floor clean block (no duplicate keys).
      AUTO_TRADE_EXCLUDED_SYMBOLS='ZORA,DAIMON,ZEROCLAW,OPENAGENTMARKET';
      AUTO_TRADE_EXCLUDED_SYMBOL_KEYWORDS='OPENAGENT,CLAWSWARM,UNICLAW';
      HONEYPOT_GUARD_IN_PAPER='true';
      PAPER_ALLOW_WATCHLIST_SOURCE='false';
      PAPER_RESET_ON_START='false';
      AUTO_TRADE_ENTRY_MODE='single';
      AUTO_TRADE_TOP_N='1';
      MAX_OPEN_TRADES='1';
      MAX_BUYS_PER_HOUR='32';
      MAX_TX_PER_DAY='140';
      V2_ENTRY_EXPLORE_MAX_SHARE='0.08';
      EXECUTION_RUNNER_ALLOW_EXPLORE='false';
      ENTRY_REQUIRE_POSITIVE_CHANGE_5M='true';
      ENTRY_MIN_PRICE_CHANGE_5M_PERCENT='0.30';
      SAFE_MIN_VOLUME_5M_USD='65';
      SAFE_MIN_LIQUIDITY_USD='9000';
      MIN_EXPECTED_EDGE_PERCENT='0.95';
      MIN_EXPECTED_EDGE_USD='0.0110';
      EV_FIRST_ENTRY_MIN_NET_USD='0.0018';
      EV_FIRST_ENTRY_MIN_NET_USD_GREEN_A_CORE_MULT='1.00';
      SYMBOL_CONCENTRATION_GUARD_ENABLED='true';
      SYMBOL_CONCENTRATION_MAX_SHARE='0.10';
      NO_MOMENTUM_EXIT_MAX_PNL_PERCENT='-0.15';
      WEAK_TRADE_EARLY_MIN_HOLD_SECONDS='70';
      WEAK_TRADE_EARLY_MIN_AGE_PERCENT='30';
      WEAK_TRADE_EARLY_MAX_PNL_PERCENT='-0.20';
      HOLD_MAX_SECONDS='210';
      ...
      MAX_TX_PER_DAY='180';
      V2_ENTRY_EXPLORE_MAX_SHARE='0.10';
      EXECUTION_RUNNER_ALLOW_EXPLORE='false';
      ENTRY_REQUIRE_POSITIVE_CHANGE_5M='true';
      ENTRY_MIN_PRICE_CHANGE_5M_PERCENT='0.25';
      SAFE_MIN_VOLUME_5M_USD='58';
      SAFE_MIN_LIQUIDITY_USD='9000';
      MIN_EXPECTED_EDGE_PERCENT='0.90';
      MIN_EXPECTED_EDGE_USD='0.0105';
      EV_FIRST_ENTRY_MIN_NET_USD='0.0016';
      EV_FIRST_ENTRY_MIN_NET_USD_GREEN_A_CORE_MULT='1.00';
      SYMBOL_CONCENTRATION_GUARD_ENABLED='true';
      SYMBOL_CONCENTRATION_MAX_SHARE='0.11';
      NO_MOMENTUM_EXIT_MAX_PNL_PERCENT='-0.12';
      WEAK_TRADE_EARLY_MIN_HOLD_SECONDS='65';
      WEAK_TRADE_EARLY_MIN_AGE_PERCENT='28';
      WEAK_TRADE_EARLY_MAX_PNL_PERCENT='-0.15';
      HOLD_MAX_SECONDS='205';
      PAPER_MAX_HOLD_SECONDS='205';
      PAPER_GAS_PER_TX_USD='0.012';
      PAPER_APPROVE_TX_ALWAYS='false';
  ...
  @{ name='mx37_profit_engine_balanced'; base='mx30_guarded_balanced'; overrides=@{
      # Profit engine: prioritize net EV per trade while keeping controlled conveyor flow.
      AUTO_TRADE_EXCLUDED_SYMBOLS='ZORA,DAIMON,ZEROCLAW,OPENAGENTMARKET';
      AUTO_TRADE_EXCLUDED_SYMBOL_KEYWORDS='OPENAGENT,CLAWSWARM,UNICLAW';
      HONEYPOT_GUARD_IN_PAPER='true';
      PAPER_ALLOW_WATCHLIST_SOURCE='false';
      ...
      AUTO_TRADE_TOP_N='1';
      MAX_OPEN_TRADES='2';
      MAX_BUYS_PER_HOUR='52';
      MAX_TX_PER_DAY='220';
      V2_ENTRY_EXPLORE_MAX_SHARE='0.12';
      EXECUTION_RUNNER_ALLOW_EXPLORE='false';
      ENTRY_REQUIRE_POSITIVE_CHANGE_5M='true';
      ENTRY_MIN_PRICE_CHANGE_5M_PERCENT='0.20';
      SAFE_MIN_VOLUME_5M_USD='52';
      SAFE_MIN_LIQUIDITY_USD='8000';
      V2_UNIVERSE_SOURCE_CAPS='onchain:165,onchain+market:165,dexscreener:150,geckoterminal:150,watchlist:0,dex_boosts:85';
      V2_SAFETY_BUDGET_PER_SOURCE='onchain:52,onchain+market:52,dexscreener:46,geckoterminal:46,watchlist:0,dex_boosts:20';
      MIN_EXPECTED_EDGE_PERCENT='0.85';
      MIN_EXPECTED_EDGE_USD='0.0105';
      EV_FIRST_ENTRY_MIN_NET_USD='0.0014';
      EV_FIRST_ENTRY_MIN_NET_USD_GREEN_A_CORE_MULT='0.98';
      SYMBOL_CONCENTRATION_GUARD_ENABLED='true';
      SYMBOL_CONCENTRATION_MAX_SHARE='0.11';
      NO_MOMENTUM_EXIT_MAX_PNL_PERCENT='-0.10';
      WEAK_TRADE_EARLY_MIN_HOLD_SECONDS='62';
      WEAK_TRADE_EARLY_MIN_AGE_PERCENT='26';
  ...
  @{ name='mx38_profit_engine_aggressive'; base='mx31_guarded_aggressive'; overrides=@{
      # Profit engine aggressive: higher cadence with strict EV floor and anti-burst controls.
      AUTO_TRADE_EXCLUDED_SYMBOLS='ZORA,DAIMON,ZEROCLAW,OPENAGENTMARKET';
      AUTO_TRADE_EXCLUDED_SYMBOL_KEYWORDS='OPENAGENT,CLAWSWARM,UNICLAW';
      HONEYPOT_GUARD_IN_PAPER='true';
      PAPER_ALLOW_WATCHLIST_SOURCE='false';
      ...
      MAX_BUYS_PER_HOUR='68';
      MAX_TX_PER_DAY='280';
      V2_ENTRY_EXPLORE_MAX_SHARE='0.15';
      EXECUTION_RUNNER_ALLOW_EXPLORE='false';
      ENTRY_REQUIRE_POSITIVE_CHANGE_5M='true';
      ENTRY_MIN_PRICE_CHANGE_5M_PERCENT='0.15';
      SAFE_MIN_VOLUME_5M_USD='46';
      SAFE_MIN_LIQUIDITY_USD='7000';
      V2_UNIVERSE_SOURCE_CAPS='onchain:185,onchain+market:185,dexscreener:170,geckoterminal:170,watchlist:0,dex_boosts:110';
      V2_SAFETY_BUDGET_PER_SOURCE='onchain:64,onchain+market:64,dexscreener:54,geckoterminal:54,watchlist:0,dex_boosts:28';
      MIN_EXPECTED_EDGE_PERCENT='0.78';
      MIN_EXPECTED_EDGE_USD='0.0098';
      EV_FIRST_ENTRY_MIN_NET_USD='0.0012';
      EV_FIRST_ENTRY_MIN_NET_USD_GREEN_A_CORE_MULT='0.96';
      SYMBOL_CONCENTRATION_GUARD_ENABLED='true';
      SYMBOL_CONCENTRATION_MAX_SHARE='0.12';
      NO_MOMENTUM_EXIT_MAX_PNL_PERCENT='-0.06';
      WEAK_TRADE_EARLY_MIN_HOLD_SECONDS='58';
      WEAK_TRADE_EARLY_MIN_AGE_PERCENT='24';
      WEAK_TRADE_EARLY_MAX_PNL_PERCENT='-0.06';
      HOLD_MAX_SECONDS='205';
      PAPER_MAX_HOLD_SECONDS='205';
      PAPER_GAS_PER_TX_USD='0.012';
      PAPER_APPROVE_TX_ALWAYS='false';
  ...
  @{ name='mx39_golden_recovery'; base='mx11_baseline_adapted'; overrides=@{
      # Real golden baseline with only reliability/safety deltas (no aggressive re-tuning).
      PAPER_RESET_ON_START='false';
      HONEYPOT_GUARD_IN_PAPER='true';
      PAPER_ALLOW_WATCHLIST_SOURCE='false';
      PAPER_WATCHLIST_STRICT_GUARD_ENABLED='true';
      PAPER_WATCHLIST_MIN_SCORE='90';
      PAPER_WATCHLIST_MIN_LIQUIDITY_USD='150000';
      PAPER_WATCHLIST_MIN_VOLUME_5M_USD='500';
      PAPER_WATCHLIST_MIN_ABS_CHANGE_5M='0.30';
      AUTO_TRADE_EXCLUDED_SYMBOLS='ZORA,DAIMON,ZEROCLAW,OPENAGENTMARKET';
      AUTO_TRADE_EXCLUDED_SYMBOL_KEYWORDS='OPENAGENT,CLAWSWARM,UNICLAW';
      SAFE_REQUIRE_CONTRACT_SAFE='true';
      PAPER_ENTRY_IMPACT_GUARD_ENABLED='true';
      PAPER_MAX_ENTRY_IMPACT_PERCENT='0.50';
      V2_UNIVERSE_SOURCE_CAPS='onchain:140,onchain+market:140,dexscreener:120,geckoterminal:120,watchlist:0,dex_boosts:40';
      V2_SAFETY_BUDGET_PER_SOURCE='onchain:52,onchain+market:52,dexscreener:44,geckoterminal:44,watchlist:0,dex_boosts:20';
    }
  },
  @{ name='mx40_conveyor_balanced'; base='mx30_guarded_balanced'; overrides=@{
      # Conveyor balanced: hard anti-scam + no watchlist + pnl/hour-driven auto-stop.
      PAPER_RESET_ON_START='false';
      WATCHLIST_ENABLED='true';
      HONEYPOT_GUARD_IN_PAPER='true';
      PAPER_ALLOW_WATCHLIST_SOURCE='false';
      PAPER_WATCHLIST_STRICT_GUARD_ENABLED='true';
      PAPER_WATCHLIST_MIN_SCORE='92';
      PAPER_WATCHLIST_MIN_LIQUIDITY_USD='120000';
      PAPER_WATCHLIST_MIN_VOLUME_5M_USD='800';
      PAPER_WATCHLIST_MIN_ABS_CHANGE_5M='0.35';
      SAFE_REQUIRE_CONTRACT_SAFE='true';
      TOKEN_SAFETY_FAIL_CLOSED='true';
      AUTO_TRADE_EXCLUDED_SYMBOLS='ZORA,DAIMON,ZEROCLAW,OPENAGENTMARKET';
      AUTO_TRADE_EXCLUDED_SYMBOL_KEYWORDS='OPENAGENT,CLAWSWARM,UNICLAW';
      PAPER_ENTRY_IMPACT_GUARD_ENABLED='true';
      PAPER_MAX_ENTRY_IMPACT_PERCENT='0.35';
      V2_UNIVERSE_SOURCE_CAPS='onchain:220,onchain+market:220,dexscreener:220,geckoterminal:220,watchlist:22,dex_boosts:120';
      V2_SAFETY_BUDGET_PER_SOURCE='onchain:72,onchain+market:72,dexscreener:62,geckoterminal:62,watchlist:18,dex_boosts:28';
      AUTO_TRADE_ENTRY_MODE='top_n';
      AUTO_TRADE_TOP_N='12';
      MAX_OPEN_TRADES='4';
      MAX_BUYS_PER_HOUR='68';
      MARKET_MODE_STRICT_SCORE='60';
      MARKET_MODE_SOFT_SCORE='48';
      ADAPTIVE_SCORE_MIN='44';
      ADAPTIVE_SCORE_MAX='56';
      MIN_TOKEN_SCORE='45';
      MIN_EXPECTED_EDGE_PERCENT='0.50';
      MIN_EXPECTED_EDGE_USD='0.0090';
      EV_FIRST_ENTRY_MIN_NET_USD='0.0013';
      SAFE_MIN_VOLUME_5M_USD='42';
      SAFE_MIN_LIQUIDITY_USD='6500';
      ENTRY_REQUIRE_POSITIVE_CHANGE_5M='false';
      ENTRY_MIN_PRICE_CHANGE_5M_PERCENT='-0.10';
      HOLD_MAX_SECONDS='155';
      PAPER_MAX_HOLD_SECONDS='155';
      WEAKNESS_EXIT_PNL_PERCENT='-2.4';
      NO_MOMENTUM_EXIT_MAX_PNL_PERCENT='0.18';
      MAX_TOKEN_COOLDOWN_SECONDS='150';
      AUTO_TRADE_SL_REENTRY_COOLDOWN_SECONDS='900';
      PROFIT_ENGINE_ENABLED='true';
      PROFIT_ENGINE_TARGET_PNL_PER_HOUR_USD='0.50';
      PROFIT_ENGINE_WINDOW_MINUTES='60';
      PROFIT_ENGINE_MIN_CLOSED='10';
      PROFIT_ENGINE_STRICT_AVG_NET_USD='0.007';
      PROFIT_ENGINE_GOOD_AVG_NET_USD='0.013';
      PROFIT_ENGINE_MAX_N_CAP='2';
      PROFIT_ENGINE_STRICT_CORE_ONLY='true';
      BURST_GOVERNOR_ENABLED='true';
      BURST_GOVERNOR_MAX_OPENS_PER_BATCH='2';
      BURST_GOVERNOR_MAX_PER_SYMBOL_PER_BATCH='1';
      BURST_GOVERNOR_MAX_PER_CLUSTER_PER_BATCH='1';
      BURST_GOVERNOR_WINDOW_SECONDS='55';
      BURST_GOVERNOR_MAX_OPENS_PER_WINDOW='2';
      SOURCE_ROUTER_ENABLED='true';
      SOURCE_ROUTER_WINDOW_MINUTES='120';
      SOURCE_ROUTER_MIN_TRADES='8';
      PROFILE_AUTOSTOP_ENABLED='true';
      PROFILE_AUTOSTOP_INTERVAL_SECONDS='300';
      PROFILE_AUTOSTOP_MIN_RUNTIME_SECONDS='3600';
      PROFILE_AUTOSTOP_WINDOW_MINUTES='90';
      PROFILE_AUTOSTOP_WINDOW_MIN_CLOSED_TRADES='12';
      PROFILE_AUTOSTOP_MIN_PNL_PER_HOUR_USD='0.40';
      PROFILE_AUTOSTOP_MAX_SL_SUM_WINDOW_USD='-0.45';
      PROFILE_AUTOSTOP_EVENT_TAG='[AUTOSTOP][CONVEYOR_BAL]';
    }
  },
  @{ name='mx41_conveyor_aggressive'; base='mx31_guarded_aggressive'; overrides=@{
      # Conveyor aggressive: wider throughput with same hard safety boundaries.
      PAPER_RESET_ON_START='false';
      WATCHLIST_ENABLED='true';
      HONEYPOT_GUARD_IN_PAPER='true';
      PAPER_ALLOW_WATCHLIST_SOURCE='false';
      PAPER_WATCHLIST_STRICT_GUARD_ENABLED='true';
      PAPER_WATCHLIST_MIN_SCORE='90';
      PAPER_WATCHLIST_MIN_LIQUIDITY_USD='100000';
      PAPER_WATCHLIST_MIN_VOLUME_5M_USD='700';
      PAPER_WATCHLIST_MIN_ABS_CHANGE_5M='0.30';
      SAFE_REQUIRE_CONTRACT_SAFE='true';
      TOKEN_SAFETY_FAIL_CLOSED='true';
      AUTO_TRADE_EXCLUDED_SYMBOLS='ZORA,DAIMON,ZEROCLAW,OPENAGENTMARKET';
      AUTO_TRADE_EXCLUDED_SYMBOL_KEYWORDS='OPENAGENT,CLAWSWARM,UNICLAW';
      PAPER_ENTRY_IMPACT_GUARD_ENABLED='true';
      PAPER_MAX_ENTRY_IMPACT_PERCENT='0.40';
      V2_UNIVERSE_SOURCE_CAPS='onchain:260,onchain+market:260,dexscreener:250,geckoterminal:250,watchlist:30,dex_boosts:140';
      V2_SAFETY_BUDGET_PER_SOURCE='onchain:84,onchain+market:84,dexscreener:72,geckoterminal:72,watchlist:22,dex_boosts:32';
      AUTO_TRADE_ENTRY_MODE='top_n';
      AUTO_TRADE_TOP_N='16';
      MAX_OPEN_TRADES='5';
      MAX_BUYS_PER_HOUR='92';
      MARKET_MODE_STRICT_SCORE='58';
      MARKET_MODE_SOFT_SCORE='46';
      ADAPTIVE_SCORE_MIN='42';
      ADAPTIVE_SCORE_MAX='55';
      MIN_TOKEN_SCORE='44';
      MIN_EXPECTED_EDGE_PERCENT='0.45';
      MIN_EXPECTED_EDGE_USD='0.0085';
      EV_FIRST_ENTRY_MIN_NET_USD='0.0011';
      SAFE_MIN_VOLUME_5M_USD='38';
      SAFE_MIN_LIQUIDITY_USD='6000';
      ENTRY_REQUIRE_POSITIVE_CHANGE_5M='false';
      ENTRY_MIN_PRICE_CHANGE_5M_PERCENT='-0.20';
      ...
      PROFIT_ENGINE_STRICT_AVG_NET_USD='0.007';
      PROFIT_ENGINE_GOOD_AVG_NET_USD='0.013';
      PROFIT_ENGINE_MAX_N_CAP='3';
      PROFIT_ENGINE_STRICT_CORE_ONLY='true';
      BURST_GOVERNOR_ENABLED='true';
      BURST_GOVERNOR_MAX_OPENS_PER_BATCH='3';
      BURST_GOVERNOR_MAX_PER_SYMBOL_PER_BATCH='1';
      BURST_GOVERNOR_MAX_PER_CLUSTER_PER_BATCH='1';
      BURST_GOVERNOR_WINDOW_SECONDS='45';
      BURST_GOVERNOR_MAX_OPENS_PER_WINDOW='3';
      SOURCE_ROUTER_ENABLED='true';
      SOURCE_ROUTER_WINDOW_MINUTES='120';
      SOURCE_ROUTER_MIN_TRADES='8';
      PROFILE_AUTOSTOP_ENABLED='true';
      ...
      PROFILE_AUTOSTOP_WINDOW_MINUTES='90';
      PROFILE_AUTOSTOP_WINDOW_MIN_CLOSED_TRADES='12';
      PROFILE_AUTOSTOP_MIN_PNL_PER_HOUR_USD='0.50';
      PROFILE_AUTOSTOP_MAX_SL_SUM_WINDOW_USD='-0.60';
      PROFILE_AUTOSTOP_EVENT_TAG='[AUTOSTOP][CONVEYOR_AGG]';
    }
  }
)
...
for ($i = 0; $i -lt $selected.Count; $i++) {
  ...
  $lines = @(
    ...
    # Matrix profile isolation: do not inherit permissive global watchlist defaults accidentally.
    "WATCHLIST_ENABLED=false",
    "WATCHLIST_REFRESH_SECONDS=3600",
    "WATCHLIST_MAX_TOKENS=30",
    "WATCHLIST_MIN_LIQUIDITY_USD=200000",
    "WATCHLIST_MIN_VOLUME_24H_USD=500000",
    "WATCHLIST_MIN_VOLUME_5M_USD=5000",
    "WATCHLIST_MIN_PRICE_CHANGE_5M_ABS_PERCENT=1.5",
    "WATCHLIST_REQUIRE_WETH_QUOTE=true",
    "PAPER_WATCHLIST_STRICT_GUARD_ENABLED=true",
    "PAPER_WATCHLIST_MIN_SCORE=90",
    "PAPER_WATCHLIST_MIN_LIQUIDITY_USD=150000",
    "PAPER_WATCHLIST_MIN_VOLUME_5M_USD=500",
  ...
  foreach ($line in @($lines)) {
    ...
    $envMap[$key.Trim()] = [string]$pair[1]
  }
  $lines = @()
  foreach ($key in $envMap.Keys) {
    $lines += ("{0}={1}" -f $key, [string]$envMap[$key])
  }
